	...
	if (app.playbackDisplayDialogs != DialogModes.NO) {
		...
		try {
			...
			if (existingLayerSet) {
    			...
    			existingMarkerDialog.graphics.backgroundColor = existingMarkerDialog.graphics.newBrush(existingMarkerDialog.graphics.BrushType.THEME_COLOR, "appDialogBackground");
...
function doDialog() {
	...
	// match our dialog background color to the host application
 	scaleMarkerDialog.graphics.backgroundColor = scaleMarkerDialog.graphics.newBrush(scaleMarkerDialog.graphics.BrushType.THEME_COLOR, "appDialogBackground");
